...
@Table(name = "SOCIO")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Socio.findAll", query = "SELECT s FROM Socio s"),
...
public class Socio implements Serializable {
	...
	public Socio(String numeroSocio, String nombre, String dni, String fechaNac, String tlf, String correo,
			String fechaEntrada, Character categoria) {
		this.numeroSocio = numeroSocio;
		this.nombre = nombre;
		this.dni = dni;
	...
	public boolean equals(Object object) {
		...
		if ((this.numeroSocio == null && other.numeroSocio != null)
				|| (this.numeroSocio != null && !this.numeroSocio.equals(other.numeroSocio))) {
			return false;
		}
		return true;
	}
